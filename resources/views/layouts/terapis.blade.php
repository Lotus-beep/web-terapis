...
<head>
    ...
    <title>@yield('title', 'Terapis') - Rumah Bekam Salam Insani</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar {
            ...
            position: fixed;
            top: 0; left: 0;
            background: linear-gradient(180deg, #0f4a28 0%, var(--green-dark) 50%, #1e7a42 100%);
            z-index: 1000;
            overflow-y: auto;
            overflow-x: hidden;
        ...
        .sidebar .brand-text .title { color: white; font-weight: 800; font-size: .95rem; line-height: 1.2; }
        .sidebar .brand-text .sub   { color: rgba(255,255,255,.55); font-size: .72rem; }
        ...
        .sidebar .nav-link:hover { background: rgba(255,255,255,.15); color: white; }
        ...
        .topbar .page-title { font-weight: 700; font-size: .95rem; color: var(--text-dark); }
        ...
        .btn-logout:hover { background: #fbd5d2; color: var(--red-main); }
    ...
    <div class="sidebar" id="sidebar">
        <div class="brand">
            ...
            <div class="brand-text">
                ...
                <div class="sub">Panel Terapis</div>
            </div>
        </div>
        <nav class="mt-2 pb-4">
            <div class="nav-section">Menu</div>
            <a href="{{ route('terapis.dashboard') }}" class="nav-link {{ request()->routeIs('terapis.dashboard') ? 'active' : '' }}">
                <i class="bi bi-speedometer2"></i> Dashboard
            </a>
            <a href="{{ route('terapis.bookings.index') }}" class="nav-link {{ request()->routeIs('terapis.bookings.*') ? 'active' : '' }}">
                <i class="bi bi-calendar-check"></i> Booking Masuk
            </a>
            <a href="{{ route('terapis.schedule') }}" class="nav-link {{ request()->routeIs('terapis.schedule') ? 'active' : '' }}">
