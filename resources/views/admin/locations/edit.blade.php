...
<div class="card">
    <div class="card-header bg-white border-0 pt-4"><h6 class="fw-bold mb-0">Edit Lokasi</h6></div>
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.locations.update', $location->id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name_location" class="form-control" value="{{ old('name_location', $location->name_location) }}" required>
            </div>
