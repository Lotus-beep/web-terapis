...
@section('page-title', 'Tambah Bed')
@section('content')
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header bg-white border-0 pt-4">
                <h6 class="fw-bold mb-0">Form Tambah Bed</h6>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form method="POST" action="{{ route('admin.beds.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_bed" class="form-control" value="{{ old('nama_bed') }}" required placeholder="Contoh: Bed 1-A">
                    </div>
                    <div class="mb-3">
